...
exports.boletobancario = exports.PayUponInvoice = void 0;
const PayUponInvoice = {
  LEGAL_TEXT: {
    'en-DE': paypalPolicyLink => `By clicking on the button, you agree to the <a rel='noopener noreferrer' target='_blank' href='https://www.ratepay.com/legal-payment-terms/'>terms of payment</a> and <a rel='noopener noreferrer' target='_blank' href='https://www.ratepay.com/legal-payment-dataprivacy/'>performance of a risk</a> check from the payment partner, Ratepay. You also agree to PayPal’s <a target='_blank' rel='noopener noreferrer' href='${paypalPolicyLink}'>privacy statement.</a> If your request to purchase upon invoice is accepted, the purchase price claim will be assigned to Ratepay, and you may only pay Ratepay, not the merchant.`,
    'de-DE': paypalPolicyLink => `Mit Klicken auf den Button akzeptieren Sie die <a rel='noopener noreferrer' target='_blank' href='https://www.ratepay.com/legal-payment-terms/'>Ratepay Zahlungsbedingungen</a> und erklären sich mit der Durchführung einer <a rel='noopener noreferrer' target='_blank' href='https://www.ratepay.com/legal-payment-dataprivacy/'>Risikoprüfung durch Ratepay</a>, unseren Partner, einverstanden. Sie akzeptieren auch PayPals <a target='_blank' rel='noopener noreferrer' href='${paypalPolicyLink}'>Datenschutzerklärung</a>. Falls Ihre Transaktion per Kauf auf Rechnung erfolgreich abgewickelt werden kann, wird der Kaufpreis an Ratepay abgetreten und Sie dürfen nur an Ratepay überweisen, nicht an den Händler.`
  },
  ERROR_MESSAGES: {
